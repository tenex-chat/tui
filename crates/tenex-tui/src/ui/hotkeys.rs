...
impl HotkeyContext {
    ...
    pub fn from_app_state(
        ...
        match modal_state {
            ...
            ModalState::ProjectDialog(_) => return HotkeyContext::CreateProjectModal,
            ...
            ModalState::BunkerApproval(_) => return HotkeyContext::AnyModal,
            ModalState::BunkerRules(_) => return HotkeyContext::AnyModal,
            ModalState::BunkerAudit(_) => return HotkeyContext::AnyModal,
