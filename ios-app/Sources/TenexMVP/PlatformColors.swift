...
extension Color {
    ...
    static let statusDefault: Color = .gray
    static let statusDefaultBackground: Color = .gray.opacity(0.15)

    // MARK: - Feature Brands
    static let skillBrand: Color = .secondary
    static let skillBrandBackground: Color = Color.secondary.opacity(0.15)
    static let agentBrand: Color = .secondary
    ...
    static let askBrand: Color = .secondary
    static let askBrandSubtleBackground: Color = Color.secondary.opacity(0.05)
    static let askBrandBackground: Color = Color.secondary.opacity(0.15)
    static let askBrandBorder: Color = Color.secondary.opacity(0.3)

    // MARK: - Message Bubbles
    static let messageBubbleUserBackground: Color = .blue.opacity(0.15)
    static let messageBubbleAgent: Color = .systemGray6
    static let messageUserAvatarColor: Color = .blue

    // MARK: - Todo Items
    static let todoDone: Color = .green
    static let todoDoneBackground: Color = .green.opacity(0.15)
    static let todoInProgress: Color = .orange
    ...
    // MARK: - Composer
    static let composerAction: Color = .secondary
    static let composerDestructive: Color = .red
    static let composerWarning: Color = .orange

    // MARK: - Stats
    static let statCost: Color = .secondary
    static let statRuntime: Color = .secondary
    static let statAverage: Color = .purple
    static let statUserMessages: Color = .secondary
